								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											if ($query->num_rows() > 0) {?>
												<a target="_blank" href="http://localhost/ultima_diklat/berkas/<?php echo $hasil[0]->file_path ?>" class="btn btn-small text-default"></i> View</a>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data1->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data2->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data3->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data4->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data5->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data6->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data7->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
									...
									<tr>
										...
										<td>
											<a data-toggle="modal" data-target="#modal_add_new" data-id="<?=$data8->id_table;?>"  href="#uploadFile" class="open-uploadFile btn btn-primary btn-sm"><i class="fas fa-plus"></i> Upload</a>
  ...
  <div id="hapus_new" class="modal fade">
	...
	<script type="text/javascript">
		...
		$('#submit').submit(function(e){
		    ...
		    e.preventDefault(); 
		         $.ajax({
		             url:'<?php echo base_url();?>index.php/unit/document/hapus_file',
		             type:"post",
		             data:new FormData(this), //this is formData
		             processData:false,
		             contentType:false,
